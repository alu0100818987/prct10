...
\begin{abstract}
El objetivo de este documento es saber más sobre el número $\pi$ y exponerlo en un pdf con \LaTeX{}~\cite{LaTeX}. 
\end{abstract}
...
ser humano para calcular aproximaciones cada vez más exactas del número $\pi${}~\cite{PI}.
%
...
Algunas aproximaciones históricasde valores de $\pi$, anteriores a la época computacional, se muestran en la siguente tabla:\\ 
\begin{table}{}
\begin{center}
\begin{tabular}{|l|r|c|}
Cultura    &  Aproximacion & Error\\ \hline
Egipcia    &  3,1605       & 6016 ppm\\ \hline
Babilónica &  3,125        & 5282 ppm\\ \hline
...
\bibitem{LaTeX} Manual de \LaTeX{}. http://www.fceia.unr.edu.ar/lcc/cdrom/Instalaciones/LaTex/latex.html
\bibitem{PI} Informacion de $\pi$. http://es.wikipedia.org/wiki/N%C3%BAmero_%CF%80
\end{thebibliography}
